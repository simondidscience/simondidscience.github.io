  ...
  class ProductRecommendations extends HTMLElement {
    constructor() {
      ...
      function colorChanged(e) {
        ...
        productItem.querySelector('.card__title > a').setAttribute('href', variantUrl);
      
        // If we have a custom image for the variant, we change it
        var originalImageElement = productItem.querySelector('.ProductItem__Image--alternate');
        ...
        newImageElement.setAttribute('data-src', e.target.getAttribute('data-image-url'));
        newImageElement.setAttribute('width', e.target.getAttribute('data-image-width'));
        newImageElement.setAttribute('height', e.target.getAttribute('data-image-height'));
        newImageElement.setAttribute('sizes', e.target.getAttribute('data-image-sizes'));
        newImageElement.setAttribute('srcset', e.target.getAttribute('data-image-srcset'));
